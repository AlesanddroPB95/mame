...
void namcoes3_state::namcoes3(machine_config &config)
{
	...
	SEGA_namcoes3_BASEBOARD(config, ":pci:1e.0:03.0", 0);
...
\
	...
	DISK_REGION("hdd") \
	DISK_IMAGE_READONLY("es3_windows7", 0, NO_DUMP)
...
ROM_START(pointblx)
	...
	DISK_REGION("dvd")
	DISK_IMAGE_READONLY("PointBlankX/GunbulletX", 0, NO_DUMP)
ROM_END
...
GAME(2015, mkdx106u,  mkdx,      namcoes3, 0, namcoes3_state, empty_init, ROT0, "Namco", "Mario Kart GP DX (Export, Ver. 1.06/OF)",  MACHINE_NOT_WORKING|MACHINE_UNEMULATED_PROTECTION|MACHINE_NO_SOUND)
GAME(2014, mkdx,      namco_es3, namcoes3, 0, namcoes3_state, empty_init, ROT0, "Namco", "Mario Kart GP DX (Export, Ver. 1.04/OF)",  MACHINE_NOT_WORKING|MACHINE_UNEMULATED_PROTECTION|MACHINE_NO_SOUND)
